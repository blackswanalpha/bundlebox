#!/usr/bin/env bash
# @lathe applied
# @lathe-id d5e1c01a3b07
# @lathe-applied 2026-09-20T11:01:24.186Z
# @tag lathe
# @title tokens ledger → monitor status → console build
# @needs bb
# @turns 3
# @cost 0
# @safe false
#
# PROPOSED by LATHE-1 from 57 occurrence(s) across 57 session(s)
# lift 24.897 over the base rate of `console build`; confidence 0.3654 that the run continues this way once it has started.
#
