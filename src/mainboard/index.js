...
export const commands = {
  mainboard: {
    ...
    long: [
      ...
      "",
      "Views: runbook · cookbook · scoreyard · clockwork · redline · cyberrender · bugbash · turntables.",
      "Order is the run order. `turntables` is last because it reads the boards `cookbook` writes.",
