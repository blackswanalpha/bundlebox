...
export const GENERATED_MARKERS = [/^\/\/\s*(@generated|Generated by|Code generated|DO NOT EDIT)/im,
  /^#\s*(Generated by|DO NOT EDIT)/im,
  // A generated MARKDOWN file says so in an html comment; without this line a
  // derived document gets hand-fix findings filed against it, which doctrine 7
  // says can never be the right answer.
  /^<!--\s*(@generated|Generated by|DO NOT EDIT)/im, /\.g\.dart$/, /\.freezed\.dart$/, /\.pb\.(go|js|ts|py)$/,
