...
import { langOf, walk } from "../core/fs.js";
...
const GEN = [/^\/\/\s*(@generated|Generated by|Code generated|DO NOT EDIT)/im, /^#\s*(Generated by|DO NOT EDIT)/im];
const GEN_NAME = /\.g\.dart$|\.freezed\.dart$|\.pb\.(go|js|ts|py)$|_pb2\.py$|\.generated\.|\.d\.ts$|\.min\.(js|css)$|(^|\/)(vendor|third_party|public)\//;
export function isGeneratedText(r, text) {
  return GEN_NAME.test(r) || GEN.some((m) => m.test(text.slice(0, 600)));
}
